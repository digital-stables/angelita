...
NoDataStorageManager noDataStorageManager( dataStorageManagerInitParams, timeManager, generalFunctions, Serial, oled );
//SDCardManager sdCardManager( dataStorageManagerInitParams, timeManager, generalFunctions, Serial, oled );
PowerManager aPowerManager(oled , secretManager , noDataStorageManager , timeManager, generalFunctions, Serial);
...
showColor=!showColor;
 ...
 byte internalBatteryStateOfCharge = generalFunctions.getStateOfCharge(batteryVoltage);
  ...
  oled.print(r.hour);
  oled.print(":");
  if(r.minute<10)oled.print("0");
  oled.print(r.minute);
  oled.print(":");
  if(r.second<10)oled.print("0");
  oled.print(r.second);
  //
  //
  // the serial ports
